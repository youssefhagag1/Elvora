...
const { getProducts, getOneProductById, getSellerProducts, updateProduct, deleteProduct , addProduct } = require('../controllers/products.controller');
...
router.post('/', verifyToken, allowTo('seller'), uploadProductImages, addProduct);
router.route('/:id')
